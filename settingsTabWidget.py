...
class Ui_settingsTabWidget(object):
    def setupUi(self, settingsTabWidget):
        ...
        self.proxyTableWidget.setGeometry(QtCore.QRect(10, 160, 421, 251))
        self.proxyTableWidget.setObjectName("proxyTableWidget")
        ...
        self.proxyUploadGroupBox.setGeometry(QtCore.QRect(10, 9, 421, 141))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.proxyUploadPushButton.setGeometry(QtCore.QRect(240, 20, 151, 51))
        ...
        self.proxyFetchPushButton = QtWidgets.QPushButton(self.proxyUploadGroupBox)
        self.proxyFetchPushButton.setGeometry(QtCore.QRect(240, 80, 151, 51))
        self.proxyFetchPushButton.setObjectName("proxyFetchPushButton")
    ...
    def retranslateUi(self, settingsTabWidget):
        ...
        self.proxyFetchPushButton.setText(_translate("settingsTabWidget", "Fetch Online"))
